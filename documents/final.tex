...
\title{\singlespacing{\textbf{The Effect of Payment for Order Flow on Market Order Execution Quality}}}

\author[]{Saketh Aleti}

\affil[]{\small{Thesis Advisor: Professor Bruce Mizrach \\ Secondary Advisor: Professor Roger Klein}}
...
\begin{table}[!t]
	...
	\begin{tabular}{@{\extracolsep{0em}}c}
		\input{../../exhibits/descriptive/nms_mkt_shr.tex} \\
		\multicolumn{1}{@{}p{6.24in}@{}}{\textit{Note: } The data used to construct this graph was obtained from the TAQ database. Market share is defined as the percent of total NMS equity volume that each exchange received in a given month. Smaller exchanges were discluded from the graph, so total market share does not add up to 100\%.  }     \\  
	\end{tabular}
\end{table}
...
\section{Data Description}
	...
	\subsection{605 Data}
		...
		\begin{tabular}{@{}L{17.85em}rrrrrrr@{}}
			...
			\hline \\[-1.8ex] 
			\multicolumn{8}{@{}p{\textwidth}@{}}{\textit{Note: } The table reflects statistics for market orders with a size code of 21 (executions between 100-499 shares) from the fourth quarter of 2017. Price improvement is given in \$/share and execution time is given in seconds. }  \\ 
		\end{tabular}
		...
		\begin{table}[t]
			...
			\footnotesize
				...
				\begin{tabular}{@{} l   C{2.5cm}  C{2.5cm}  C{2.5cm}  C{2.5cm} @{}}
					\\[-4.5ex]
					\toprule
					& \multicolumn{4}{c}{{\textbf{Order Type}}} \\  [0.2ex]
					\cline{2-5} \\ [-1.8ex]
...
\begin{table}[t] 
	...
	\begin{tabular}{@{\extracolsep{1.05em}}lcccc} 
		...
		\hline \\[-1.8ex]  
		\multicolumn{5}{@{}p{45em}@{}}{\textit{Note: } $D_i$ denotes an indicator variable for a broker accepting POF. Standard errors are reported in parentheses. *p$\textless$0.05, **p$\textless$0.01, ***p$\textless$0.001}  \\ 
	\end{tabular} 
\end{table} 
...
\begin{table}[!t]
	\caption*{Differences in Marginal Effects for POF and Non-POF Brokers} 
	\label{fig:meplots}
	\footnotesize
	\label{fig:1}
	\begin{tabular}{@{\extracolsep{0em}}rr}
		\multicolumn{2}{@{}c@{}}{\input{../../exhibits/marginaleffects/PrImp_Pct.tex} }\\
		\input{../../exhibits/marginaleffects/PrImp_AvgAmt.tex} &  
		\input{../../exhibits/marginaleffects/PrImp_ExpAmt.tex} \\ 
		\input{../../exhibits/marginaleffects/PrImp_AvgT.tex} &  
		\input{../../exhibits/marginaleffects/All_AvgT.tex} \\ 
		
		\multicolumn{2}{@{}p{6.24in}@{}}{\textit{Note: } Marginal effects were obtained using a Gaussian kernel; the bandwidth used was the same as that which minimized the objective for the SLS regressions. The solid lines represent the difference marginal effects at each percentile, while the dashed lines represent the average difference in marginal effect. For the former, execution quality percentiles were taken from the market centers receiving order flow in the data. Average marginal effects were computed by averaging the marginal effects over the execution quality data corresponding to a particular subgroup. The gray bands represent 95\% confidence intervals for the difference in marginal effects. This difference was taken between Non-POF and POF brokers; a positive effect then suggests a relatively higher value for Non-POF brokers.}     \\  
	\end{tabular}
\end{table}
	...
	\begin{table}[htbp]
		...
		\begin{tabular}{@{\extracolsep{0.6em}}lrrrrrrrrr@{}}
			...
			\multicolumn{10}{@{} p{6.24in} @{}}{
				{\scriptsize The following table was generated using the 606 disclosures. The set of market center columns contain the average percent of orders routed to each respective market center over the available data set. Brokers are split into two categories: POF and Non-POF. POF brokers generally, but not neccesarily, receive direct compensation for order flow routing, while Non-POF brokers do not accept payment for order flow; see the data section for a more detailed description. Additionally, this table only includes market centers whose 605 data was available for analysis. Percentages may not add up to 100\% due to rounding. } 
			}  \\ \\ [-1.8ex]
			\toprule
...
\begin{landscape}	
	...
	\begin{table}[h]
		...
		\begin{tabular}{@{}lrrrrrrr@{}}
			...
			\hline \\[-1.8ex] 
		    BNYC &          32693477 &               0 &      0.014408 &    86.80\% &      0.012507 &    0.142701 &  0.191631 \\
...
\begin{thebibliography}{9}
	...
	\bibitem[Barker(2014)]{Barker}
	Barker, M. (2014). SLS: Stata module to perform semiparametric least squares. Satistical Software Components S457927, Boston College Department of Economics.
	
	\bibitem[Battalio, Corwin, and Jennings(2016)]{BCJ}
	...
	\bibitem[Battalio, Shkilko, and Van Ness(2016)]{BSVN}
	...
	\bibitem[Battalio and Holden(2001)]{BH}
	...
	\bibitem[Chordia and Subrahmanyam(1995)]{Chordia}
	...
	\bibitem[Ichimura(1993)]{Ichimura}
	...
	\bibitem[Kandel and Marx(1999)]{kandel}
	Kandel, E., \&  Marx, L.M. (1999). Payments for Order Flow on Nasdaq. The Journal Of Finance, (1), 35.
	
	\bibitem[FINRA(2015)]{FINRA notice}
	Financial Industry Regulatory Authority, 2015. Regulatory Notice - Best Execution 15-46. \href{https://www.finra.org/sites/default/files/notice_doc_file_ref/Notice_Regulatory_15-46.pdf}{https://www.finra.org/sites/default/files/notice\_doc\_file\_ref/Notice\_Regulatory\_15-46}
	
	\bibitem[NASD(2001)]{NASD}
	...
	\bibitem[Parlour and Rajan(2003)]{parlour}
	...
	\bibitem[SEC(2018)]{pilot}
	Securities and Exchange Commission, (2018). SEC Proposes Transaction Fee Pilot for NMS Stocks. \href{https://www.sec.gov/news/press-release/2018-43}{\textit{https://www.sec.gov/news/press-release/2018-43}}
	
	
	\bibitem[SEC(2005)]{NMS adoption}
	Securities and Exchange Commission, (2005). SEC adopts regulation NMS and provisions regarding Investment Advisers Act of 1940. \href{https://www.sec.gov/news/press/2005-48.htm}{\textit{https://www.sec.gov/news/press/2005-48.htm}}
	
	\bibitem[Tobin(1958)]{Tobin}
	Tobin, J. (1958). Estimation of Relationships for Limited Dependent Variables. Econometrica, (1), 24. doi:10.2307/1907382
